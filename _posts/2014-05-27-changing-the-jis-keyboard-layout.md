---
layout: post
title: "Changing the JIS Layout of My Japanese Keyboard"
...
I used a keyboard layout editor named [*Ukelele*](http://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=ukelele). The default layout is now like this:

![default layout](_images/defaultlayout.jpg)

The layout with `shift` key is being pressed:

![shift default layout](_images/shiftdefaultlayout.jpg)
...
<!--Created by Ukelele version 2.2.8 on 2014-05-26 at 23:54 (GMT+8)-->
<!--Last edited by Ukelele version 2.2.8 on 2014-05-27 at 00:45 (GMT+8)-->
<keyboard group="0" id="508" name="code input" maxout="1">
    <layouts>
